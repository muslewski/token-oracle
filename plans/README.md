...
| 009 | Release automation: release-please PAT wiring | P2 | S | human step | TODO (no drift — workflows untouched since `d2b4d32`, verified at `ada32e9`) |
...
| 011 | Pin GitHub Actions to commit SHAs | P3 | S | 009 (soft) | TODO (no drift — workflows untouched since `d2b4d32`, verified at `ada32e9`) |
...
| 013 | Entry-point discovery for third-party sources | P2 | S-M | 002 (DONE) | TODO (refreshed at `ada32e9` 2026-07-02 — base.py excerpt byte-identical, ADAPTERS.md still teaches import-before-use; executable now) |
...
| 018 | TUI shell — alt screen, key input, past/present/future tabs | P1 | L | — | TODO |
...
| 022 | agentic-sage reciprocal integration (doctor detect + hint) | P2 | S | — (soft: 015, 021) | TODO |
